/**
 * Calculates the score based on distance, city difficulty, and current level.
 *
 * Formula:
 ...
 * @param cityTier Difficulty tier of the city (1 = easy, 2 = medium, 3 = hard)
 * @param level Current game level (1-based)
 * @returns Final score with all multipliers applied
 */
export function calculateScore(distanceKm: number, cityTier: number = 1, level: number = 1): number {
 ...
 * @returns Minimum score required to pass the level (total for 5 rounds)
 */
